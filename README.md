...
<body>
    ...
    <div class="wrapperLetterForm" style="display: none;">
        <div class="boxLetter">
            ...
            <div class="formLetter">
                ...
                <div class="wrapperLetter">
                    ...
                    <div class="textLetter">
                        <h2>Gửi các bạn nữ lớp 9A!</h2>
                        <p class="contentLetter">💖 Chúc mừng ngày Quốc tế Phụ nữ 08/03! 💖...</p>
        ...
        <!-- Hình ảnh xung quanh nền -->
        <div class="image-surround">
            <img src="./image/friend1.jpg" alt="Friend 1">
            <img src="./image/friend2.jpg" alt="Friend 2">
            <img src="./image/friend3.jpg" alt="Friend 3">
            <img src="./image/friend4.jpg" alt="Friend 4">
            <img src="./image/friend5.jpg" alt="Friend 5">
            <img src="./image/friend6.jpg" alt="Friend 6">
            <img src="./image/friend7.jpg" alt="Friend 7">
            <img src="./image/friend8.jpg" alt="Friend 8">
        </div>
    </div>
    ...
    <style>
        ...
        .image-surround img:nth-child(1) {
            top: 10%;
            left: 20%;
        }

        .image-surround img:nth-child(2) {
            top: 20%;
            right: 15%;
        }

        .image-surround img:nth-child(3) {
            bottom: 30%;
            left: 10%;
        }

        .image-surround img:nth-child(4) {
            bottom: 20%;
            right: 5%;
        }

        .image-surround img:nth-child(5) {
            top: 40%;
            left: 5%;
        }

        .image-surround img:nth-child(6) {
            top: 50%;
            right: 25%;
        }

        .image-surround img:nth-child(7) {
            bottom: 10%;
            left: 30%;
        }

        .image-surround img:nth-child(8) {
            bottom: 40%;
            right: 20%;
        }

        .wrapperLetterForm.active .image-surround {
            opacity: 1;
        }
    </style>
    ...
    <script>
        function openLetter() {
            ...
            setTimeout(() => {
                document.querySelector(".wrapperLetterForm").classList.add("active");
            }, 100);
        }

        function closeLetter() {
            document.querySelector(".wrapperLetterForm").classList.remove("active");
            setTimeout(() => {
    ...
    <script>
        ...
        const textLetterH2 = "Gửi các bạn nữ lớp 9A!";
        ...
        const textLetterP = "💖 Chúc mừng ngày Quốc tế Phụ nữ 08/03! 💖. Chúc các bạn luôn rạng rỡ như ánh nắng ban mai, hạnh phúc như những đóa hoa nở rộ, và tràn đầy yêu thương trong từng khoảnh khắc.Mong rằng mỗi ngày của các bạn đều ngập tràn niềm vui, tiếng cười và những điều tuyệt vời nhất! 🌸💫.Happy Women's Day! 💐❤️";
